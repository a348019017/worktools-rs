...
pub type KdTree2<A, const K: usize> = kiddo::float::kdtree::KdTree<A, u64, K, 128, u32>;

use std::collections::HashMap;

pub mod point;
use point::{intersects, normalise_angle, Point, PointValue};
...
fn concave_hull_inner(point_list: &mut Vec<Point>, k: usize, hull: &mut Vec<Point>) -> bool {
    ...
    let mut tree: KdTree2<_, 2> = KdTree::new(); //(&entries).into();
